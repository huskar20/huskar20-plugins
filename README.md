...
1. Open **Settings**, and under **Customize** in the sidebar click **Plugins**
2. Click **Add** at the top right, then **Add marketplace**
3. In the dialog, choose **Add from a repository** (not **Browse Anthropic sources**)
...
**"start my experience record"** instead — it needs no connectors, just a folder
to save into, and builds the honest inventory a resume gets written from.
